...
import {PreviewMintCollateral} from "../preview/PreviewMintCollateral.sol";
import {PreviewDepositCollateral} from "../preview/PreviewDepositCollateral.sol";
...
abstract contract MaxDepositCollateral is PreviewMintCollateral, PreviewDepositCollateral {
     ...
     */
    function maxDepositCollateral(MaxDepositMintCollateralVaultState memory state)
        external
        view
        nonReentrantRead
        returns (uint256)
