...
import {MaxDepositMintBorrowVaultData} from "../../../../../structs/data/vault/max/MaxDepositMintBorrowVaultData.sol";
import {PreviewMint} from "../preview/PreviewMint.sol";
import {PreviewDeposit} from "../preview/PreviewDeposit.sol";
...
abstract contract MaxDeposit is PreviewMint, PreviewDeposit {
     ...
     */
    function maxDeposit(MaxDepositMintBorrowVaultState memory state) external view nonReentrantRead returns (uint256) {
