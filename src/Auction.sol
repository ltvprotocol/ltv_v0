...
abstract contract Auction is State, Lending {
    function executeAuctionCollateral(int256 deltaUserCollateralAssets) external isFunctionAllowed returns (int256) {
    ...
    function executeAuctionBorrow(int256 deltaUserBorrowAssets) external isFunctionAllowed returns (int256) {
